...
<p style="margin:0 0 20px;">For common questions, visit our <a href="${appUrl}/faq" style="color:#2D7A85;">FAQ</a>. For anything else, we're always here:
...
For common questions: https://mindreset.ai/faq
For anything else, we're always here: support@mindreset.ai
...
<p style="margin:0 0 20px;">Ответы на частые вопросы — в нашем <a href="${appUrl}/ru/faq" style="color:#2D7A85;">разделе вопросов и ответов</a>. По остальным вопросам мы всегда на связи:
<a href="mailto:support@mindreset.ai" style="color:#2D7A85;">support@mindreset.ai</a></p>
...
Ответы на частые вопросы: https://mindreset.ai/ru/faq
По остальным вопросам мы всегда на связи: support@mindreset.ai
