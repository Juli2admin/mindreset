...
- **No trauma scenes.** If the user offers a memory or a younger-self image, the AI receives it (*"thank you for telling me"*), gently returns to the body and the present, and continues the Adult Self work in the present.
...
1. **Ground and arrive.** Brief — a slow breath, a moment to settle.
...
- Do not move past it if the user is uncomfortable with the separation — return to grounding and witnessing.
...
1. **Ground and arrive.** *"Take a slow breath and settle here for a moment."*
...
- The user moves into a younger self or trauma image → gently return to grounding and the Adult Self. *"That's there, and we'll come to it carefully when the time is right. For now, stay with this steadier presence."*
...
**Signs to slow (the AI returns to grounding and the Observer Seat or Stage 2 work):**
...
- Intensity rises during the activation — return to grounding, return to the Observer Seat, slow down.
- Grief or shame about *"not having been adult enough"* surfaces — receive, validate, do not deepen: *"That feeling makes sense. You did the best you could with what you had. Let's sit with that for a moment, steady, with a slow breath."*
...
**AI move.**
1. **Ground briefly.** *"Take a slow breath and arrive here for a moment."*
