...
The Adult Self built in Stage 3 leads. The parts met in Stage 4 are still inside, often carrying the foreign material on the user's behalf — the Adult Self gently lifts it off them. The Adult Self remains the steady reference.
...
- **Adult-Self-led stabilisation** (continuing from Stage 4) — the Adult Self does the discrimination work; the user is the one who decides what is theirs.
...
1. **Adult Self present.** *"Let [Adult Self in user's words] be here with you — take a moment to feel that presence."*
...
**Watch-for markers**:
- Rage spike at the original speaker → receive, validate (*"of course there's anger — this has been heavy"*), do not deepen the anger, return to grounding.
- Shame spike (*"why didn't I notice before?"*) → soften with Self-Compassion. *"You couldn't have seen this earlier. You see it now."*
- Disorientation (*"so who am I, if not the one who carries this?"*) → normal Surface marker. Return to grounding and Adult Self. The reclaiming work comes later.
...
1. **Adult Self + foreign material identified.** Confirm both, with the user steady.
...
- Shame surge → stop the release. Return to Adult Self and Self-Compassion. Try again another day.
...
**Signs to slow (the AI returns to grounding and Adult Self work, or steps back a layer):**
- Mild foreign guilt after release — normal. Name it as foreign, do not deepen.
- Temporary confusion (*"who am I, if not the caretaker?"*) — normal Surface marker. Return to grounding.
...
**AI move.**
1. **Adult Self.** *"Let [Adult Self in user's words] be here with you — take a moment to feel that presence."*
